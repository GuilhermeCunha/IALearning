...
if __name__ == '__main__':
    ...
    img1 = img.open('/home/viniciusdantz/Documentos/Repositório Github/Python/IALearning/Projeto/Aulas/digitalizacao.png')
    width, height = img1.size
    
    cv2.imwrite('texture-and-noise.png', add_noise(texture(blank_image(width = width, height = height, background=230), sigma=4), sigma=10))

    #cv2.imwrite('noise.jpg', add_noise(blank_image(1024, 1024), sigma=10))
    # blur = img1.filter(filter.BLUR)
    img2 = img.open('/home/viniciusdantz/Documentos/Repositório Github/Python/texture-and-noise.png')
